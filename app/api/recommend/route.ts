...
3. Major literary awards (Booker, Pulitzer, Nobel, National Book Award, and similar) are not, on their own, evidence that a pick is non-obvious. Fame is fame whether it comes from sales charts or prize committees — a prize-winning book can still be a genuinely great, surprising fit for this specific reader, but don't reach for it because it feels "safely prestigious" rather than because it's the best match for their stated taste.
